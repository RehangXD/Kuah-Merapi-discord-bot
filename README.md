...
*   **Music:** Supports YouTube and Spotify links, queue management, looping (single/all), and playlist support.
    <img width="305" height="212" alt="Image" src="https://github.com/user-attachments/assets/222840fa-b8a6-4bc8-b2db-3067ffbf34ff" />
*   **Greetings:** Automated messages trigger for your server.
    <img width="317" height="142" alt="Image" src="https://github.com/user-attachments/assets/2e53e3bb-bf81-4a12-98aa-1578771afff2" />
